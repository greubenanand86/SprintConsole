...
Durable organizational intelligence for {Product Name}. Decisions, rationale, learnings, and constraints that must survive team changes and context resets.

> Root memory file: `products/{product-id}/PRODUCT_MEMORY.md`
